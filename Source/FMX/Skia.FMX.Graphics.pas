...
var
  ...
  OriginalCanvasServiceWasRegistered: Boolean;
begin
  ...
  OriginalCanvasServiceWasRegistered := TPlatformServices.Current.SupportsPlatformService(IFMXCanvasService);

  if OriginalCanvasServiceWasRegistered then
  begin
